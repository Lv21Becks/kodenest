                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" name="category" id="category"
                                value="{{ old('category', $blogPost->category) }}" required list="categories"
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" name="featured_image" id="featured_image"
                                value="{{ old('featured_image', $blogPost->featured_image) }}" placeholder="URL or mapped path (e.g. blog/image.png)"
                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-purple focus:ring focus:ring-brand-purple/20 transition-all">
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea name="excerpt" id="excerpt" rows="3" required
                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-purple focus:ring focus:ring-brand-purple/20 transition-all">{{ old('excerpt', $blogPost->excerpt) }}</textarea>
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea name="content" id="content" rows="12" required
                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-purple focus:ring focus:ring-brand-purple/20 transition-all font-mono text-sm">{{ old('content', $blogPost->content) }}</textarea>
                            @error('content')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" name="author" id="author" value="{{ old('author', $blogPost->author) }}"
                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-purple focus:ring focus:ring-brand-purple/20 transition-all">
                            @error('author')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-span-1">
                            <label for="read_time" class="block text-sm font-medium text-gray-700">Read Time
                                (minutes)</label>
                            <input type="number" name="read_time" id="read_time" min="1"
                                value="{{ old('read_time', $blogPost->read_time) }}"
                                class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-brand-purple focus:ring focus:ring-brand-purple/20 transition-all">
                            @error('read_time')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-span-2">
                            <div class="flex items-center p-4 bg-gray-50 rounded-lg border border-gray-100">
                                <input type="checkbox" name="published" id="published" value="1" {{ old('published', $blogPost->published) ? 'checked' : '' }}
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="text-xs text-gray-500">Uncheck to revert to draft.</p>
                                </div>
                            </div>
                        </div>
                    </div>
